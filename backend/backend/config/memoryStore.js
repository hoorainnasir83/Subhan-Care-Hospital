...
const memoryStore = {
  users: [
    ...
    { id: 'u5', name: 'Alice Johnson (Patient)', email: 'patient@subhancare.com',     passwordHash: bcrypt.hashSync('patient123', 10),      role: 'Staff',        doctorId: null, patientId: 'SC-PAT-10001' },
    { id: 'u6', name: 'Alice Johnson',         email: 'alice.j@gmail.com',           passwordHash: bcrypt.hashSync('patient123', 10),      role: 'Staff',        doctorId: null, patientId: 'SC-PAT-10001' },
    { id: 'u7', name: 'Demo Patient',           email: 'abc@gmail.com',               passwordHash: bcrypt.hashSync('patient123', 10),      role: 'Staff',        doctorId: null, patientId: 'SC-PAT-10002' },
  ],
  doctors: [
