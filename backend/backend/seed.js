...
const seedUsers = [
  { name: 'Subhan Administrator',  email: 'admin@subhancare.com',        password: 'admin123',        role: 'Admin',        doctorId: null },
  { name: 'Dr. Sarah Connor',      email: 'doctor@subhancare.com',       password: 'doctor123',       role: 'Doctor',       doctorId: 'doc-1' },
  { name: 'Reception Staff',       email: 'receptionist@subhancare.com', password: 'receptionist123', role: 'Receptionist', doctorId: null },
  { name: 'Billing Officer',       email: 'billing@subhancare.com',      password: 'billing123',      role: 'Billing',      doctorId: null }
];
...
const runSeed = async (shouldExit = true) => {
  try {
    if (mongoose.connection.readyState !== 1) {
      await mongoose.connect(process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/subhancare');
    }
